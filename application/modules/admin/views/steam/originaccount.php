  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Origin Account Diolog</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="box box-info" style="border-top: none;background: none;">
            ...
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">Origin Account</label>
...
$(document).ready(function(){
    var tblDef={
        "ajax": {
            url:'steam/GetOriginAccountList',
            dataSrc:"",
            "type" : "POST"
        },
        bJQueryUI: true,
